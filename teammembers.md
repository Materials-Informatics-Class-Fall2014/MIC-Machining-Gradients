...
{% if page.author1.image %}<img src="/images/{{ page.author1.image }}" height="42" width="42">{% endif %}
...
{% if page.author2.image %}<img src="/images/{{ page.author2.image }}" height="42" width="42">{% endif %}
